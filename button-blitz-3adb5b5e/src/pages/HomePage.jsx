    ...
    <div className="min-h-screen min-h-dvh flex flex-col items-center justify-center bg-gradient-to-br from-[rgb(var(--background-start))] to-[rgb(var(--background-end))] text-[rgb(var(--text-primary))] p-4">
      ...
      <div className="absolute top-4 right-4">
        <Link to={createPageUrl('Settings')}>
          <Button variant="ghost" className="text-[rgb(var(--text-secondary))] hover:text-[rgb(var(--text-primary))]" onClick={handleButtonClick} onMouseEnter={() => playSound('menu_hover')}>
      ...
      >
        ...
        <div className="space-y-4">
          <Link to={createPageUrl('LocalGame')} className="w-full">
            <Button className="w-full h-16 text-lg bg-[rgba(var(--highlight-bg),var(--highlight-opacity))] hover:bg-[rgba(var(--highlight-bg),0.8)] text-[rgb(var(--highlight-text))] border-2 border-[rgba(var(--border-color),var(--border-opacity))]" onClick={handleButtonClick} onMouseEnter={() => playSound('menu_hover')}>
          ...
          {loading ? (
            ...
            <Link to={createPageUrl('OnlineLobby')} className="w-full">
              <Button className="w-full h-16 text-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:scale-105 transition-transform text-white" onClick={handleButtonClick} onMouseEnter={() => playSound('menu_hover')}>
                <Wifi className="w-6 h-6 mr-3" />
                Online Multiplayer
              </Button>
            </Link>
          ) : (
            <Button onClick={handleLogin} className="w-full h-16 text-lg bg-gradient-to-r from-green-500 to-teal-500 hover:scale-105 transition-transform text-white" onMouseEnter={() => playSound('menu_hover')}>
